        ...
        <div className="h-20 bg-neutral-100 border-b border-neutral-300 flex items-center justify-between px-8 sticky top-0 z-30">
            ...
            <div className="flex-1 max-w-2xl relative">
                ...
                <input
                    ...
                    className="w-full bg-neutral-400 border-none rounded-2xl py-3 pl-11 pr-4 text-sm text-neutral-800 placeholder:text-neutral-600 focus:ring-2 focus:ring-primary-300/20 transition-all font-medium"
                />
            </div>
