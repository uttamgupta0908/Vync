                ...
                <div className="space-y-2">
                    {[
                        ...
                        <div key={community.name} className="flex items-center justify-between p-2 hover:bg-gradient-to-r hover:from-primary-100/10 hover:to-primary-300/10 rounded-xl transition-all duration-200 cursor-pointer group">
                            ...
                            <button className="text-[10px] font-bold text-primary-300 bg-primary-100/10 px-2.5 py-1 rounded-full hover:bg-primary-300 hover:text-neutral-100 hover:shadow-md transition-all duration-200 flex-shrink-0">
                                Join
                            </button>
                        </div>
                    ))}
