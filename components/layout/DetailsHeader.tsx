    ...
    return (
        <header className="sticky top-0 bg-neutral-100/80 backdrop-blur-md border-b border-neutral-300 px-4 py-2 z-40 flex items-center justify-between h-[53px]">
            ...
            <div className="flex items-center gap-2">
                ...
                <button className="bg-primary-300 text-neutral-100 px-4 py-1.5 rounded-full text-[15px] font-bold hover:bg-primary-200 transition-colors shadow-md shadow-primary-300/20 flex items-center gap-2">
