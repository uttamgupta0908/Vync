                ...
                <div className="flex-1 max-w-md hidden sm:block mx-4">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2 bg-neutral-300 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-primary-300/20 focus:bg-neutral-100 transition-all"
                        />
                    </div>
                </div>
