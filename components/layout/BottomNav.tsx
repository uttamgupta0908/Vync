...
export default function BottomNav() {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 bg-neutral-100 border-t border-neutral-300 sm:hidden z-50 pb-safe">
            ...
            <button className="absolute -top-16 right-4 w-14 h-14 bg-primary-300 rounded-full text-neutral-100 shadow-lg flex items-center justify-center hover:bg-primary-200 transition-colors">
