...
export default function LoginModal() {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
            <div
                className="bg-neutral-100 rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden animate-in zoom-in-95 duration-200"
                ...
                <div className="relative p-5">
                    ...
                    <div className="space-y-2">
                        <button
                            ...
                            className="w-full py-2.5 px-4 bg-neutral-800 hover:bg-neutral-600 text-neutral-100 font-bold rounded-xl text-sm transition-colors flex items-center justify-center gap-2"
                        >
                        ...
                        <button
                            ...
                            className="w-full py-2.5 px-4 bg-neutral-100 border border-neutral-200 hover:bg-neutral-50 text-neutral-800 font-bold rounded-xl text-sm transition-colors flex items-center justify-center gap-2"
                        >
